...
&nbsp;   chmod +x cloudshell\_deploy.sh

&nbsp;   ./cloudshell\_deploy.sh
...
5\.  \*\*Save the Output.\*\* When finished, the terminal will print a block of configuration text starting with `AWS\_REGION=....`. \*\*Copy this entire block.\*\* You will need it for Phase 2.
